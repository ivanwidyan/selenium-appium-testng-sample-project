...
package com.testing.example.constants;

public class ExampleConfigConstants {
    // Capabilities Set up
    ...
    public final static String APP_PACKAGE = "com.example.android";
    public final static String APP_ACTIVITY = "com.example.android.appentry.splash.SplashActivity";
